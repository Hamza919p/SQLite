...
public class RattingAttr {
    ...
    public Drawable[] getLayerList() {
        return new Drawable[]{createLayerDrawableWithTintAttrRes(bgDrawable, androidx.appcompat.R.attr.colorControlHighlight, keepOriginColor),
                // progress & secondaryProgress must be ClipDrawable
                createClippedLayerDrawableWithTintColor(starDrawable, Color.TRANSPARENT),
                createClippedLayerDrawableWithTintAttrRes(starDrawable,  androidx.appcompat.R.attr.colorControlActivated, keepOriginColor)};
    }
