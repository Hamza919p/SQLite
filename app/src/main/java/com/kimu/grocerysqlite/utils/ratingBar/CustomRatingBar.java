package com.kimu.grocerysqlite.utils.ratingBar;
...
public class CustomRatingBar extends RatingBar implements RatingBar.OnRatingBarChangeListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStarDrawable = typedArray.getResourceId(R.styleable.AndRatingBar_starDrawable, R.drawable.star_on);
        if (typedArray.hasValue(R.styleable.AndRatingBar_bgDrawable)) {
            mBgDrawable = typedArray.getResourceId(R.styleable.AndRatingBar_bgDrawable, R.drawable.star_on);
        } else {
